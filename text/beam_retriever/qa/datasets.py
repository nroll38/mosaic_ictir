...
class MHReaderDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #print("SAMPLE: {}".format(sample["context"]))
        ...
        if self.type == 'hotpot':
            ...
            for sup in (zip(sample['supporting_facts']["title"], sample["supporting_facts"]["sent_id"])):
