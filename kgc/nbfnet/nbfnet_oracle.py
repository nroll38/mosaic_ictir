...
def parse_args():
    ...
    parser.add_argument("-c", "--config", help="yaml configuration file", default="config/inductive/fb15k237_oracle2.yaml")
...
if __name__ == "__main__":
    ...
    for (s,r,o) in secrets:
        ...
        path_triples = get_triples_paths(paths, s, o)
        try:
            os.system("python script/run.py -c config/inductive/fb15k237_oracle2.yaml --gpus [0] --version v1 > "+log_fp)
