...
if __name__ == "__main__":
    ...
    log_fp = "./experiments/exp_v1_33_select/log_rank_test.txt"

    results_fp = "experiments/exp_v1_33_select/grail_oracle_results.json"
    ...
    for (s,r,o) in secrets:
        ...
        path_triples = get_triples_paths(paths, s, o)
        try:
            os.system("python test_ranking.py -d exp_v1_33_select/test -e exp_v1_33_select")
